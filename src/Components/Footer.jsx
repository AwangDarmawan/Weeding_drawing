  ...
  return (
    <div className="relative my-2 mx-3 ">
      ...
      >
         ...
         <h1 data-aos="fade-up-right" className="text-sm text-[#8A1C14] font-semibold">
          Made By
        </h1>
        ...
        <h2 className="text-2xl sm:text-3xl font-bold tracking-wide mt-1 font-feltpen text-[#8A1C14]">
    4daDigital
  </h2>
  <p className="mt-3 text-sm sm:text-base font-semibold text-[#8A1C14] animate-pulse italic">
